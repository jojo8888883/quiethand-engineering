(() => {
  ...
  const storageKey = "quiethand-m3-user-judgements-v1";
  const notesStorageKey = "quiethand-m3-user-notes-v1";
  let judgements = {};
  let notes = {};
  try {
  ...
  archiveButton.addEventListener("click", () => {
    ...
    const payload = {
      format: "quiethand-m3-user-review",
      version: 1,
    ...
    link.download = `quiethand-m3-review-${new Date().toISOString().replace(/[:.]/g, "-")}.json`;
